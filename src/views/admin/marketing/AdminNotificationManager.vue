  ...
  <div class="space-y-6">
    ...
    <div class="flex gap-4">
      ...
      >
        ...
        <option v-for="t in NOTIFICATION_TYPES" :key="t.value" :value="t.value">
          {{ t.label }}
        </option>
      </select>
    </div>
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
              <span
                v-if="!item.userId"
                class="text-green-600 font-bold bg-green-50 px-2 py-0.5 rounded"
                >Tất cả (Broadcast)</span
              >
    ...
    <div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      ></div>
      <div
        class="bg-white dark:bg-gray-800 w-full max-w-lg rounded-2xl shadow-xl p-6 relative z-10 animate-fade-in-up"
      >
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              class="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1"
                >Người nhận (User ID)</label
              >
              <input
                v-model="newNoti.userId"
                type="number"
                class="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            ...
            <div>
              <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1"
                >Mã tham chiếu (Optional)</label
              >
              <input
                v-model="newNoti.referenceId"
                class="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
