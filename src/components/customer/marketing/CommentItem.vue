...
import { useCommentStore } from '@/stores/marketing/comment.store' // Import Store
...
<template>
  <div class="group animate-fade-in">
    <div class="flex gap-3">
      <div
        class="w-8 h-8 md:w-10 md:h-10 rounded-full overflow-hidden flex-shrink-0 border border-gray-100"
      >
      ...
      <div class="flex-1">
        <div
          class="bg-gray-50 dark:bg-gray-800 p-3 rounded-2xl rounded-tl-none inline-block min-w-[200px] relative"
        >
          <div class="flex items-center justify-between gap-2 mb-1">
            <span class="font-bold text-sm text-gray-900 dark:text-gray-100">
              ...
              <span
                ...
                class="text-[10px] bg-green-100 text-green-700 px-1.5 py-0.5 rounded ml-1 border border-green-200"
                >Admin</span
              >
            </span>
          ...
          <p
            class="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-line leading-relaxed pr-8"
          >
            {{ comment.content }}
          </p>
          ...
          <div
            ...
            class="absolute -bottom-2 -right-2 bg-white dark:bg-gray-700 rounded-full shadow-sm border border-gray-100 dark:border-gray-600 px-1.5 py-0.5 flex items-center gap-1"
          >
            ...
            <span class="text-[10px] text-gray-500 dark:text-gray-300 font-medium">{{
              comment.likeCount
            }}</span>
          </div>
        </div>
    ...
    <div
      ...
      class="pl-10 md:pl-14 mt-4 space-y-4 border-l-2 border-gray-100 dark:border-gray-700"
    >
      <CommentItem
