...
import { useCommentStore } from '@/stores/marketing/comment.store'
...
<template>
  <div
    class="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 mt-8"
  >
    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-6 flex items-center gap-2">
      Bình luận
      <span
        class="text-sm font-normal text-gray-500 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full"
      >
        {{ totalComments }}
      </span>
    </h3>
    ...
    <div class="mb-8">
      <CommentForm :loading="loading" @submit="handleAddComment" />
    </div>
    ...
    <div
      v-else
      class="text-center py-8 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-dashed border-gray-200 dark:border-gray-700"
    >
