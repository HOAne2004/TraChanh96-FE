...
<template>
  <div
    class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-start gap-4"
  >
    <div
    ...
    <div class="flex-1">
      ...
      <div
        v-if="isOutOfRadius"
        class="mt-2 bg-red-50 text-red-600 text-xs p-2 rounded border border-red-100 flex items-center gap-2 font-semibold"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
