  ...
  <div class="fixed top-4 right-4 z-50 space-y-3">
    <TransitionGroup name="toast">
      <div
        ...
        :key="toast.id"
        class="flex items-center justify-between gap-3 px-4 py-3 rounded-xl shadow-xl min-w-[300px] max-w-md
               text-white border-l-4 transform transition-all duration-300 ease-out backdrop-blur-sm"
...
function typeClass(type) {
  ...
  switch (type) {
    ...
    case 'warning':
      return baseClasses + 'bg-gradient-to-r from-yellow-500/95 to-yellow-600/95 border-yellow-700 text-gray-900'
    default:
