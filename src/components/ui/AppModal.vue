      ...
      >
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t dark:border-gray-700">
          ...
          <button
            ...
            @click="handleCancel"
            class="px-5 py-2.5 text-sm font-medium rounded-lg transition-colors border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
