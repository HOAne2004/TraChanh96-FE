...
<template>
  <div
    class="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center animate-fade-in"
  >
    <div class="w-64 md:w-80 mb-8 relative">
      <div
        class="absolute inset-0 bg-green-200 rounded-full blur-2xl opacity-30 animate-pulse"
      ></div>
      <img
        :src="constructionImg"
        alt="Đang phát triển"
